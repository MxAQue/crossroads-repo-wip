...
func update_sprite():
	...
	Global.selected_body_color = body_sprite.material
...
func _on_color_button_pressed() -> void:
	body_sprite.material = get_palette_shader(palettes["skincolour"]["base"], palettes["skincolour"]["palettes"][bodycolour])
	bodycolour = (bodycolour + 1) % palettes["skincolour"]["palettes"].size()
	update_sprite()
...
func _on_random_button_pressed() -> void:
	body_sprite.material = get_palette_shader(palettes["skincolour"]["base"], palettes["skincolour"]["palettes"][bodycolour])
	bodycolour = rng_colors.randi_range(1, palettes["skincolour"]["palettes"].size() - 1) % palettes["skincolour"]["palettes"].size()
	update_sprite()
